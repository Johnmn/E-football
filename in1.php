...
mysqli_query($conn,"insert into tickets(Dates,Clubs,quantity) values('".$_SESSION['id']."','$qty','$val34')");
...
<html lang="en">
	<head>
		...
		<link href="assets/css/blue.css" rel="alternate sty lesheet" title="Blue color">
...
if(!empty($_SESSION['cart'])){
				...
				<tr>
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								<a href="in.php" class="btn btn-upper btn-primary outer-left-xs">Continue Shopping</a>
 ...
 <?php
 $pdtid=array();
    $sql = "SELECT * FROM matches WHERE id IN(";
				...
				<tr>
					...
					<td class="cart-image">
						<a class="entry-thumbnail" href="detail.html">
						    <img src="admin/productimages/<?php echo $row['id'];?>/<?php echo $row['Venue'];?>" alt="" width="114" height="146">
						</a>
					</td>
					<td class="cart-product-name-info">
						<h4 class='cart-product-description'><a href="product-details.php?pid=<?php echo htmlentities($pd=$row['id']);?>" ><?php echo $row['Clubs'];
...
$_SESSION['sid']=$pd;
						...
						<div class="row">
							...
							<div class="col-sm-8">
<?php $rt=mysqli_query($conn,"select * from matches where id='$pd'");
