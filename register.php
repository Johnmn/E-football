...
if(isset($_POST['send']))
{
$row1=mysqli_query($con,"select email,password from fans where email='".$_POST['femail']."'");
...
<div class="main">
	 ...
	 <div class="sap_tabs" >	
			...
			<div class="resp-tabs-container">
					<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0"style="background: green;">
					<div class="facts"style="background: black;">
						...
						<div class="register">
							<form name="registration" method="post" action="" enctype="multipart/form-data">
								...
								<div class="sign-up">
									...
									<input type="submit" name="signup"  value="Sign Up"><a href="login.php">
									<div class="clear"> </div>
								</div>
							</form>
