                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body" id="exampl">
                                        <?php
 $vid=$_GET['viewid'];
$ret=mysqli_query($conn,"select * from matches where ID='$vid'");
$cnt=1;
while ($row=mysqli_fetch_array($ret)) {

?>
                                        <h4 class="header-title" style="color: blue">View Detail of Ticket ID: <?php  echo $row['Date'];?></h4>
                                ...
                                <tr>
                                    <th >Ticket </th>
                                    <td style="padding-left: 10px"><?php  echo $noadult=1;?></td>
  ...
  <i class="fa fa-print fa-2x" style="cursor: pointer;"  OnClick="CallPrint(this.value)" >print</i>
</p>
                                </div>
                            </div>
                            <!-- basic form end -->
